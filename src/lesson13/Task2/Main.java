...
/* Задание №2*. Допустим есть txt файл с номерами документов.
   ...
   добавить информацию о том, почему этот документ не валиден. */

public class Main {

  public static void main(String[] args) {
    //путь к исходному файлу: src/lesson13/Task2/ListOfDocuments.txt
    DocumentValidation.startValidation();
  }
}
